...
class Step5_AuthorASTWorkshop extends AbstractASTTransformation {
    ...
    void visit(final ASTNode[] nodes, final SourceUnit source) {
        ...
        if (nodes[0] instanceof AnnotationNode && nodes[1] instanceof ClassNode) {
            ...
            if (value instanceof ConstantExpression) {
                nodes[1].addField('$STEP5_AUTHOR_WORKSHOP', ACC_PUBLIC | ACC_FINAL | ACC_STATIC, ClassHelper.STRING_TYPE, value)
            } else {
