...
class Step5_AuthorASTAnswer extends AbstractASTTransformation {
    @Override
    void visit(final ASTNode[] nodes, final SourceUnit source) {
        ...
        if (nodes[0] instanceof AnnotationNode && nodes[1] instanceof ClassNode) {
            ...
            if (value instanceof ConstantExpression) {
                nodes[1].addField('$STEP5_AUTHOR_ANSWERS', ACC_PUBLIC | ACC_FINAL | ACC_STATIC, ClassHelper.STRING_TYPE, value)
            } else {
